...
$('.js-select-2').on('change', '', function (e) {
  if($('.s-form-block-input__company .select2-selection__rendered').text() === 'Для компаний') {
    $('.s-form-block-input-certificate').removeClass('s-form-block-input__unvisible')
  } else {
    $('.s-form-block-input-certificate').addClass('s-form-block-input__unvisible')
  }
});
$(".js-select-3").select2({
...
scene9.to(".price-1", {
  ...
  onComplete: () => {
    ...
    $({numberValue: 0}).animate({numberValue: 2}, {
...
scene10.to(".price-2", {
  ...
  onComplete: () => {
    ...
    $({numberValue: 0}).animate({numberValue: 332}, {
...
scene11.to(".price-3", {
  ...
  onComplete: () => {
    ...
    $({numberValue: 0}).animate({numberValue: 83}, {
...
$(".s-steps-item-icon1").each(function(){
  ...
  scene5.to( $(this), { duration:1, backgroundColor: '#326CF9',  ease: "power1.in",})
